...
#     'http://127.0.0.1:8000',
#     'http://clinic.pythonanywhere.com'
# )
...
if os.environ.get('DJANGO_ENV') == "LOCAL":
    DATABASES = {
        'default': {
            ...
            'NAME': 'polanguiveterina$clinic_database',
            'USER': 'root',
            'PASSWORD': '',
            'HOST': '127.0.0.1',
            'PORT': '3306',
    ...
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.mysql',
            'NAME': 'polanguiveterina$clinic_database',
            'USER': 'polanguiveterina',
            'PASSWORD': 'notCommonPassword123$',
            'HOST': 'polanguiveterinaryclinic.mysql.pythonanywhere-services.com',
            'PORT': '3306',
            'OPTIONS': {
                    'init_command': "SET sql_mode='STRICT_TRANS_TABLES'",
            }
